...
public class ProductsFromTheWebPages extends BasePage{

    public ProductsFromTheWebPages(WebDriver driver) { super(driver);}

    By FirstProduct = By.linkText("Awesome Granite Chips");
    public void ClickOnTheFirstProduct() {driver.findElement(FirstProduct).click();}

    By SecondProduct = By.linkText("Awesome Metal Chair");
    public void ClickOnTheSecondProduct() {driver.findElement(SecondProduct).click();}
