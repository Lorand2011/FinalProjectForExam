...
public class CheckoutAndCancel extends BasePage {

    @Test
    public void CheckoutAndCancel() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("#root > div > div:nth-child(2) > form > div > div:nth-child(2) > a")).click();
        ...
        Assert.assertTrue(element.contains("Your cart"));
    }
}