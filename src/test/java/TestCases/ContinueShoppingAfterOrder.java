...
public class ContinueShoppingAfterOrder extends BasePage {

    @Test
    public void ContinueShoppingAfterOrder() throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("#root > div > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > a")).click();
