...
public class IncreaseTheQuantityInCart extends BasePage {

    @Test
    public void IncreaseTheQuantityInCart() throws InterruptedException {
        ...
        Assert.assertTrue(element.contains("7"));
    }
}