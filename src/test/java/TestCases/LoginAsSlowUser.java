...
public class LoginAsSlowUser extends BasePage {
    @Test
    public void LoginAsSlowUser() throws InterruptedException {


        driver.findElement(By.cssSelector("#responsive-navbar-nav > div:nth-child(2) > span > span > span > button > svg > path")).click();
        driver.findElement(By.id("user-name")).click();
        driver.findElement(By.id("user-name")).sendKeys("turtle");
        ...
        Assert.assertTrue(element.contains("turtle"));
    }
}